...
public class connexion_responsable extends JFrame {
	...
	public connexion_responsable() {
		...
		panel.setBounds(300, 46, 275, 201);
		...
		txtPass.setBounds(98, 67, 135, 22);
		panel.add(txtPass);
		...
		textUser.setBounds(98, 32, 135, 24);
		panel.add(textUser);
		...
		btnValider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					String sql="Select * from responsable where login_resp='"+textUser.getText()+"' and password='"+txtPass.getText().toString()+"' ";
					...
					if(rs.next()) {
						...
						setState(ICONIFIED);
						MenuPrincipalResponsable mp=new MenuPrincipalResponsable();
						mp.setVisible(true);
					}
					else
		...
		label.setIcon(new ImageIcon(connexion_responsable.class.getResource("/images/responsibility.png")));
		label.setBounds(95, 183, 157, 64);
		contentPane.add(label);
		
		JLabel label_1 = new JLabel("");
		label_1.setIcon(new ImageIcon(connexion_responsable.class.getResource("/images/LOGO-ENSAK-800.png")));
		label_1.setBounds(64, 11, 142, 91);
